...
exports.TITLE_EXISTS = {
    ...
    ar: { field: "Title", msg: "سبق استعمال هذا الاسم" },
};
...
exports.SERVER_ERR = {
    ...
    ar: {
        ...
        sentence: "سنعمل على حل المشكلة في أقرب وقت  , أعد المحاولة أو تحميل الصفحة",
    },
};
...
exports.PHONE_EXISTS = {
    en: { msg: "phone number already exists", field: "phone" },
    ar: { msg: "تم استعمال هذا الرقم من قبل", field: "phone" },
};
